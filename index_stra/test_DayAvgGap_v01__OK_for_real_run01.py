...
def ProcOneLine(line):
    ...
    if 1 == GlobalVar.stratety_type:
        WideOfGap = 0.001087
        if GlobalVar.is_hold and "buy"==GlobalVar.hold_direction and ma1 < GlobalVar.buy_sell_threadhold * (1 + WideOfGap):
           modelDirection = "sell"
        if GlobalVar.is_hold and "sell" == GlobalVar.hold_direction and ma1 > GlobalVar.buy_sell_threadhold * (1 - WideOfGap):
           modelDirection = "buy"
